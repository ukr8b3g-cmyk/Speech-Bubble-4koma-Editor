...
| 文字入力欄以外で`T` | 選択対象に応じてTextレイヤーを追加 |
| Ctrl＋0 | キャンバスを全体表示 |
...
Settingsではテーマと言語を即時切替できます。Exportでは出力フォルダーを参照ボタンで指定し、指定先への自動保存または前回選択したフォルダーの記憶を選べます。PNG／JPEG／WebP、品質・圧縮、ファイル名、日付サブフォルダー、Overlay PNG、同名ファイルの世代バックアップも設定できます。
