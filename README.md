...
ページ画像は素材置き場です。サムネイル右上の×で削除できます。使用中の画像を削除すると、その画像を使用しているコマからも外れます。
...
Settingsではテーマと言語を即時切替できます。出力先、PNG／JPEG／WebP、品質・圧縮、ファイル名、日付サブフォルダー、Overlay PNG、世代バックアップ、自動保存（5～3600秒）、起動時復元、キャッシュ管理を設定できます。
