"""Pillow layout compatibility renderer. Browser Canvas is the current export path.

Shared asset discovery lives in asset_catalog.py; keep this module's public
rendering contract for saved legacy layouts and explicit pillow_layout_v1 clients.
"""
import hashlib
import json
import math
...
from speech_bubble_editor.asset_catalog import (
    _BASIC_SYMBOL_KINDS,
    _FRAME_ASSETS,
    _FRAME_ASSETS_2X,
...
from speech_bubble_editor import asset_catalog
...
def rebuild_asset_caches():
    """Compatibility entry point for callers of the original renderer API."""
    counts = asset_catalog.rebuild_asset_caches()
    clear_render_caches()
    return counts
