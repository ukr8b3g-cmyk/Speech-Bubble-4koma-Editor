...
def render_composite(*args, **kwargs):
    """Load the Pillow compatibility path only when explicitly requested."""
...
def register_routes(app):
    ...
    async def health():
        return {
            "ok": True,
            "name": "Speech Bubble 4koma Editor",
            "version": __version__,
    ...
    print("[Speech Bubble 4koma Editor] Editor ready")
    print(f"[Speech Bubble 4koma Editor] Output: {output_root()}")
    print(f"[Speech Bubble 4koma Editor] Layouts: {layout_root()}")
